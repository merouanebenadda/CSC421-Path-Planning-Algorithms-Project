...
public:
    ...
    std::vector<Point> rrtPath(const Problem& problem, double delta_s, double delta_r, int max_iterations); // Builds the RRT and returns the path from start to goal
