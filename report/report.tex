...
Thus the complexity of the algorithm remains the same, as the optimization step is done in $O(I)$ time, where $I$ is the number of iterations needed to build the tree, which is negligible compared to the complexity of building the tree.
