...
**Question 2** : [scripts/visualize.py](scripts/visualize.py) for the visualization of the results. We chose to use Python and Matplotlib for this part, as it is more convenient for plotting and visualizing data.

**Question 3** : [src/PSO.cpp](src/PSO.cpp) and [include/PSO.hpp](include/PSO.hpp) for the definition of the Particle class and the fitness function. 

**Question 4** : [src/PSO.cpp](src/PSO.cpp) and [include/PSO.hpp](include/PSO.hpp) for the implementation of the particle structure and collision checking.

**Question 7** : [src/PSO.cpp](src/PSO.cpp) and [include/PSO.hpp](include/PSO.hpp) for the implementation of the PSO algorithm.

**Question 12** : [src/utils.cpp](src/utils.cpp) for the intersection computation with obstacles used in the refined fitness function.
...
**Question 22** : [src/RRT.cpp](src/RRT.cpp), [src/Problem.cpp](src/Problem.cpp) and [src/utils.cpp](src/utils.cpp) for the intelligent sampling implementation.
